...
0|32|bottom|( custom/power hyprland/workspaces )|( idle_inhibitor clock custom/spotify )|( tray ) ( backlight network pulseaudio pulseaudio#microphone cpu memory  )
1|32|top|( custom/power hyprland/workspaces )|( idle_inhibitor clock custom/spotify )|( tray ) ( backlight network pulseaudio pulseaudio#microphone cpu memory  )
